...
public class DashboardPack {
    ...
    /**
     * The action URL a caller must hold for this pack to match them — the pack's persona gate since
     * #1050, replacing {@code roles}. One pack per capability, so which dashboard a user gets is
     * decided by the same grant that decides whether they may query at all.
     */
