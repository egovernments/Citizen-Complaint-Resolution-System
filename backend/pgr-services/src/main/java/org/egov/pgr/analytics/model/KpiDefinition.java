...
public class KpiDefinition {
    ...
    /**
     * The action URL a caller must hold to see this tile — the tile's only visibility gate since
     * #1050. It replaces {@code rbac.visibleTo}: a role list here could disagree with the role
     * list in the frontend and the one in the pack, and all three regularly did.
     */
    private String requiredActionUrl;

    /** Opt-in to the anonymous public dashboard. Additive, and never an employee grant. */
