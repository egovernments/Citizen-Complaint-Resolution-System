-- Add routing-quality flags to complaint_facts for first-assignment rate KPIs.
-- has_been_assigned: at least one ASSIGN/REASSIGN workflow action occurred.
-- is_reassigned: more than one assignment action (initial ASSIGN + at least one REASSIGN).
