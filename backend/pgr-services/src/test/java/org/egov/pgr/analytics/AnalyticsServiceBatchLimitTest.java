...
/** Pins the request budget before any SQL execution. */
public class AnalyticsServiceBatchLimitTest {

    @Test
    public void oversizedBatchIsRejectedBeforeAnyDatabaseWork() {
        ...
        AnalyticsService service = new AnalyticsService(
                null, null, jdbc, null, null, new AnalyticsMetrics(), null);
