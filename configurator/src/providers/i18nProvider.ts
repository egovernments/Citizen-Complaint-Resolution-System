...
const customEnglishMessages: TranslationMessages = {
  ...
  app: {
    ...
    providers: {
      ...
      // Sync WhatsApp templates (map-and-confirm) dialog.
      sync_action: 'Sync WhatsApp templates',
      sync_title: 'Sync WhatsApp Templates from Twilio',
      sync_hint: 'Pull your account\'s approved WhatsApp Content templates, review the matched routing rows, then persist them into the notification provider-template master. Twilio credentials stay server-side — only the approved template SIDs are returned.',
      sync_pull: 'Sync from Twilio',
      sync_again: 'Sync again',
      sync_counts: '%{matched} matched · %{unmatched} skipped · %{total} total',
      sync_no_integration: 'Add a Twilio WhatsApp provider on this page first, then sync again.',
      sync_col_audience: 'Audience',
      sync_col_transition: 'Action → State',
      sync_col_locale: 'Locale',
      sync_col_template: 'Template SID',
      sync_col_vars: 'Vars',
      sync_col_status: 'Approval',
      sync_col_result: 'Result',
      sync_select_all: 'Select all',
      sync_will_create: 'new',
      sync_will_update: 'update',
      sync_failed: 'failed',
      sync_none: 'No approved Twilio Content templates map to the PGR routing tuples yet.',
      sync_skipped: '%{n} skipped (not mapped / not approved)',
      sync_selected_count: '%{n} selected',
