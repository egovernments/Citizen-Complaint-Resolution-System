...
const DashboardCard = () => {
  ...
  // Same access-control capability check as the DashboardModule route guard
  // (shared useDashboardAccess hook), so the card and the route always agree.
  // Render nothing while it resolves so the card doesn't flash in or out.
