...
const ROLES = {
  ...
  PGR: ["GRO", "PGR_LME", "CSR", "SUPERUSER", "CMS_RECEPTION_OFFICER", "CMS_SCREENING_OFFICER", "CMS_SUPERVISOR", "CMS_CASE_MANAGER", "CMS_VIEWER"],
};
...
const PGRCard = () => {
  ...
  let links = [
    ...
    // SUPERUSER-only cross-department search (backend: _admin/_search, PR #1260)
    generateLink("ES_PGR_ADMIN_SEARCH", "admin-search", ["SUPERUSER"]),
  ];
