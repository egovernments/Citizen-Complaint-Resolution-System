...
const EmployeeApp = ({ path, stateCode, userType, tenants }) => {
  ...
  const PGRComplaintSearch = Digit?.ComponentRegistryService?.getComponent("PGRComplaintSearch");
  ...
  return (
    <Switch>
      ...
      <AppContainer className="ground-container">
        ...
        <React.Fragment>
          <BreadCrumbs
            ...
            crumbs={[
              ...
              {
                internalLink: `/${window?.contextPath}/employee/pgr/search`,
                content: t("PGR_SEARCH_COMPLAINT"),
        ...
        {/* Route for the new Search Citizen Complaint screen (department + assignee filters) */}
        <PrivateRoute
          path={`${path}/search`}
          component={() => <PGRComplaintSearch />}
        />
