...
// ---------------------------------------------------------------------------
// Choropleth map  -> OpenComplaintsByGeographyWidget
// The widget fetches its own ward geometry; it needs the per-layer ward-count
// arrays. If the BE already supplies the layered payload use it directly; else
// shape the generic ward rows into the { wow_change, sla_breach } layer arrays.
// ---------------------------------------------------------------------------
