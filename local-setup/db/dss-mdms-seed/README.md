...
- **`enable-dashboard.sh --help`** — usage and flags. The full runbook (prerequisites, the seven
  ...
  enablement-PR comment that graduates into `docs/dashboard-configuration.md` on merge
- Runbook (issue #631): the original, with the manual form of each step
- `docs/dashboard-configuration.md` — the reference doc this seeds against
