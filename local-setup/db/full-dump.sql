...
accesscontrol-action-2008	pg	2008	ACCESSCONTROL-ACTIONS-TEST.actions-test	{"id": 2008, "url": "/pgr-services/v2/request/_search", "code": "null", "name": "Search PGR Request", "path": "", "enabled": false, "displayName": "Search PGR Request", "orderNumber": 0, "serviceCode": "pgr-services", "parentModule": "", "method": "POST", "resource": {"complaint": {"attributes": {"citizen.mobileNumber": {"condition": {"or": [{"==": [{"var": "user.attributes.tenantWide"}, true]}, {"==": [{"var": "resource.complaint.accountId"}, {"var": "user.uuid"}]}]}, "onDeny": {"strategy": "MASK_SHOW_LAST_N", "n": 2, "maskChar": "X"}}, "citizen.name": {"condition": {"or": [{"==": [{"var": "user.attributes.tenantWide"}, true]}, {"==": [{"var": "resource.complaint.accountId"}, {"var": "user.uuid"}]}]}, "onDeny": {"strategy": "REDACT"}}, "citizen.userName": {"condition": {"or": [{"==": [{"var": "user.attributes.tenantWide"}, true]}, {"==": [{"var": "resource.complaint.accountId"}, {"var": "user.uuid"}]}]}, "onDeny": {"strategy": "REDACT"}}}, "scope": {"axes": ["department", "jurisdiction"], "roleScopes": {"GRO": {"department": "NONE", "jurisdiction": "OWN"}, "PGR_LME": {"department": "OWN", "jurisdiction": "OWN"}, "SUPERVISOR": {"department": "OWN", "jurisdiction": "NONE"}}, "default": {"department": "NONE", "jurisdiction": "OWN"}}}}, "condition": {"or": [{"==": [{"var": "user.attributes.tenantWide"}, true]}, {"and": [{"==": [{"var": "user.type"}, "CITIZEN"]}, {"==": [{"var": "resource.complaint.accountId"}, {"var": "user.uuid"}]}]}, {"and": [{"==": [{"var": "user.type"}, "EMPLOYEE"]}, {"in": [{"var": "resource.complaint.department"}, {"var": "user.attributes.departments"}]}, {"in": [{"var": "resource.complaint.boundary"}, {"var": "user.attributes.jurisdictions"}]}]}]}}	t	system-mdms-seed	system-mdms-seed	1785200000000	1785200000000
