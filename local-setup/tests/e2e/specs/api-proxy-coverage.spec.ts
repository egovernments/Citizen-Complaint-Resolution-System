...
// All tests in this file require a remote proxy environment (not localhost)
test.beforeEach(async () => {
  test.skip(!process.env.BASE_URL, 'Requires BASE_URL env var pointing to remote proxy environment');
});
